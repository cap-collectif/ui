    ...
    <Box position="relative" height="100%" {...props}>
      ...
      >
        <defs>
          ...
          <path
            d="M10 0h252a4 4 0 014 4v77.898H0V4a4 200 0 014-4z"
            id="cap-placeholder-bg-b"
          />
        </defs>
        <g filter="url(#cap-placeholder-bg-a)" fill="none" fillRule="evenodd">
          <mask id="cap-placeholder-bg-c" fill="#fff">
            <use xlinkHref="#cap-placeholder-bg-b" />
          </mask>
          <use fill={fillColor} xlinkHref="#cap-placeholder-bg-b" />
          <path
