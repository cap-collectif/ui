...
- 🛠 Make `Menu` component more accessible [#536](https://github.com/cap-collectif/ui/pull/536)
...
- 💥 Inputs UI rework - improving accessibility [#507](https://github.com/cap-collectif/ui/pull/507)
...
- 🛠 Accessibility improvements on `Search` and `CodeInput` [#517](https://github.com/cap-collectif/ui/pull/517)
...
- 🐛 Improve accesibility on `Tooltip` [#508](https://github.com/cap-collectif/ui/pull/508)
...
- 💄 Fix `Toast` component max width [#480](https://github.com/cap-collectif/ui/pull/480)
- 🆕 Add keyboard navigation to `TabBar` component [#479](https://github.com/cap-collectif/ui/pull/479)
...
- 🆕 Better focus-visible handling for better accessibility [#440](https://github.com/cap-collectif/ui/pull/440)
...
- 🐛 Accessibility improvements [#424](https://github.com/cap-collectif/ui/pull/424)
...
- 🛠 Refactor CodeInput component [#418](https://github.com/cap-collectif/ui/pull/418)
...
- 🐛 Fix `reakit` types [#408](https://github.com/cap-collectif/ui/pull/408)

## 1.9.1

`2024-02-22`

- 🆕 Add new Icons [#405](https://github.com/cap-collectif/ui/pull/405)
...
- 💥 Change breakpoint [#376](https://github.com/cap-collectif/ui/pull/376)

## 1.7.5

`2023-08-03`

- 🆕 Add new Icons [#374](https://github.com/cap-collectif/ui/pull/374)

## 1.7.4

`2023-07-18`

- 🆕 Add new Icons [#372](https://github.com/cap-collectif/ui/pull/372)
...
- 🐛 Fix `Search` component clear action [#361](https://github.com/cap-collectif/ui/pull/361)
...
- 💄 Added `Map`, `Vote` and `List` icons [#356](https://github.com/cap-collectif/ui/pull/356)
...
- 🆕 Adds `ColorPicker` Component [#293](https://github.com/cap-collectif/ui/pull/293)

## 1.4.1

`2022-06-27`

- 🐛 Export hook `useMultiStepModal` [#289](https://github.com/cap-collectif/ui/pull/289)
